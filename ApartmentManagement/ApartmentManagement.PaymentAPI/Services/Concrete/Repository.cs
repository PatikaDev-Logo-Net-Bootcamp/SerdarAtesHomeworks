...
{
    public class Repository<T> : IRepository<T, string> where T : BaseEntity, new()
    {
        protected readonly IMongoCollection<T> Collection;
        private readonly MongoDbModel settings;

        protected Repository(IOptions<MongoDbModel> options)
        {
